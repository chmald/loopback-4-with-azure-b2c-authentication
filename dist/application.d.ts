...
declare const Chmaldloopback4Application_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
    ...
    dataSource<D extends any>(dataSource: D | import("@loopback/repository").Class<D>, name?: string | undefined): import("@loopback/boot").Binding<D>;
...
export declare class Chmaldloopback4Application extends Chmaldloopback4Application_base {
